...
class Settings(BaseSettings):
    ...
    gemini_image_model: str = os.getenv("GEMINI_IMAGE_MODEL", os.getenv("GEMINI_IMAGE_GEN_MODEL", "gemini-2.5-flash-image"))
    gemini_image_gen_model: str = os.getenv("GEMINI_IMAGE_GEN_MODEL", os.getenv("GEMINI_IMAGE_MODEL", "gemini-2.5-flash-image"))
