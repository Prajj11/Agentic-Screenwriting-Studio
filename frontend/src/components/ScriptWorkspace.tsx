                ...
                <>
                  {scene.status === 'final' && (
                    <>
                      ...
                      <button className="sidebar__btn" style={{ padding: '0.3rem 0.6rem', fontSize: '0.75rem', minHeight: 'auto', background: 'var(--surface-sunken)', width: 'auto', color: '#34a853' }} onClick={(e) => { e.stopPropagation(); onAction(`Generate cinematic Veo video for Scene ${scene.scene_number}`); }}>🎬 Veo 3.1</button>
                    </>
                  )}
